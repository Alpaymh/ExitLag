...
namespace AracServis
{
    public partial class AracSil : Form
    {
        ...
        private void AracSil_Load(object sender, EventArgs e)
        {
            ...
            this.tbl_AraclarTableAdapter.Fill(this.dataSet2.Tbl_Araclar);
        }
        ...
        private void BtnKa_Click(object sender, EventArgs e)
        {
            ...
            DataSet2TableAdapters.Tbl_AraclarTableAdapter ds = new DataSet2TableAdapters.Tbl_AraclarTableAdapter();
            dataGridView1.DataSource = ds.AracSil();
        }
