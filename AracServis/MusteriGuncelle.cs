...
namespace AracServis
{
    public partial class MusteriGuncelle : Form
    {
        ...
        private void dataGridView1_CellDoubleClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            musteriad.Text = dataGridView1.Rows[secilen].Cells[0].Value.ToString();
            musterisoyad.Text = dataGridView1.Rows[secilen].Cells[1].Value.ToString();
            ...
            musteriid.Text = dataGridView1.Rows[secilen].Cells[4].Value.ToString();
        }
