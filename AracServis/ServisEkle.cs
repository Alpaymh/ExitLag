...
namespace AracServis
{
    public partial class ServisEkle : Form
    {
        ...
        private void ServisEkle_Load(object sender, EventArgs e)
        {
            ...
            this.dataTable6TableAdapter.Fill(this.dataSet2.DataTable6);
        ...
        private void BtnLi_Click(object sender, EventArgs e)
        {
            ...
            DataSet2TableAdapters.DataTable6TableAdapter ds = new DataSet2TableAdapters.DataTable6TableAdapter();
            dataGridView1.DataSource = ds.servis();
        }
    }
}
