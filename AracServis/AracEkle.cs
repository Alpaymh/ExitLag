...
namespace AracServis
{
    public partial class AracEkle : Form
    {
        ...
        private void AracEkle_Load(object sender, EventArgs e)
        {
            ...
            this.dataTable7TableAdapter.Fill(this.dataSet2.DataTable7);
            this.dataTable4TableAdapter.Fill(this.dataSet2.DataTable4);
        ...
        private void BtnLi_Click(object sender, EventArgs e)
        {
            ...
            DataSet2TableAdapters.DataTable2TableAdapter ds = new DataSet2TableAdapters.DataTable2TableAdapter();
            dataGridView1.DataSource = ds.AraclariListele();
        }
        ...
        {
            // Dataset bağlantısıyla araç tablosunu yenilemek İçin kullanıldı.
            DataSet2TableAdapters.DataTable7TableAdapter ds = new DataSet2TableAdapters.DataTable7TableAdapter();
            dataGridView1.DataSource = ds.aracekle();
        }
